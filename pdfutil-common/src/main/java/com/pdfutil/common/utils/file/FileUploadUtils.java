package com.pdfutil.common.utils.file;
...
import com.pdfutil.common.constant.Constants;
import com.pdfutil.common.exception.file.FileNameLengthLimitExceededException;
import com.pdfutil.common.exception.file.FileSizeLimitExceededException;
import com.pdfutil.common.exception.file.InvalidExtensionException;
import com.pdfutil.common.utils.DateUtils;
import com.pdfutil.common.utils.StringUtils;
import com.pdfutil.common.utils.uuid.IdUtils;
import com.pdfutil.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = PdfUtilConfig.getProfile();
    ...
    {
        int dirLastIndex = PdfUtilConfig.getProfile().length() + 1;
